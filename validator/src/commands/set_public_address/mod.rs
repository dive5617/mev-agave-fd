...
pub fn execute(matches: &ArgMatches, ledger_path: &Path) -> Result<()> {
    ...
    set_public_address!(
        set_public_address_args.tvu_addr,
        set_public_tvu_address,
        "set public tvu address"
    )?;
    Ok(())
}
...
mod tests {
    ...
    #[test]
    fn verify_args_struct_by_command_set_public_address_tvu() {
        verify_args_struct_by_command(
            command(),
            vec![COMMAND, "--tvu", "127.0.0.1:8082"],
            SetPublicAddressArgs {
                tpu_addr: None,
                tpu_forwards_addr: None,
    ...
    #[test]
    fn verify_args_struct_by_command_set_public_address_all() {
        verify_args_struct_by_command(
            command(),
            vec![
                COMMAND,
