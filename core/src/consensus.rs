...
impl From<Tower> for Tower1_14_11 {
    fn from(tower: Tower) -> Self {
        Self {
            ...
            mostly_confirmed_threshold: tower.mostly_confirmed_threshold,
            threshold_ahead_count: tower.threshold_ahead_count,
            after_skip_threshold: tower.after_skip_threshold,
            threshold_escape_count: tower.threshold_escape_count,
            last_config_check_seconds: tower.last_config_check_seconds,
        }
    }
}
